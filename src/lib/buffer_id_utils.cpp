...
std::map<ifm3d::buffer_id, ifm3d_ros2::buffer_id_utils::message_type> message_type_map = {
  ...
  { ifm3d::buffer_id::RADIAL_DISTANCE_NOISE, ifm3d_ros2::buffer_id_utils::message_type::raw_image },
  { ifm3d::buffer_id::REFLECTIVITY, ifm3d_ros2::buffer_id_utils::message_type::raw_image },
...
std::map<ifm3d::buffer_id, std::string> topic_name_map = {
  ...
  { ifm3d::buffer_id::RADIAL_DISTANCE_NOISE, "distance_noise" },
