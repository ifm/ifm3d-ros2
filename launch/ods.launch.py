...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "ods_name",
            default_value="ods",
            description="Name for the ODS node and used as tf prefix",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    ods_node = LifecycleNode(
        ...
        namespace=LaunchConfiguration("ods_namespace"),
    ...
    configure_ods = EmitEvent(
        event=ChangeState(
            lifecycle_node_matcher=matches_action(ods_node),
    ...
    activate_ods = RegisterEventHandler(
        OnStateTransition(
            target_lifecycle_node=ods_node,
