...
| `distance_noise`                | `sensor_msgs/msg/Image`                 | The radial distance noise image                                                                                                  |
...
| `reflectivity`                  | `sensor_msgs/msg/Image`                 | Reflectivity value for each pixel of the distance image                                                                          |
