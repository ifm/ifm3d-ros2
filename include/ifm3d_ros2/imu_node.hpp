...
#ifndef IFM3D_ROS2_IMU_NODE_HPP_
#define IFM3D_ROS2_IMU_NODE_HPP_
...
{
/**
 * Managed node that implements the IMU data publisher of ifm3d for ROS 2.
 */
class IFM3D_ROS2_PUBLIC ImuNode : public rclcpp_lifecycle::LifecycleNode
{
public:
  /**
   ...
   */
  explicit ImuNode(const std::string& node_name, const rclcpp::NodeOptions& opts);

  /**
   * Delegates construction to the above ctor.
   */
  explicit ImuNode(const rclcpp::NodeOptions& opts);
...
#endif  // IFM3D_ROS2_IMU_NODE_HPP_
