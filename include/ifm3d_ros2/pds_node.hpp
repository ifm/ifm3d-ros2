...
#ifndef IFM3D_ROS2_PDS_NODE_HPP_
#define IFM3D_ROS2_PDS_NODE_HPP_
...
{
/**
 * Managed node that implements the PDS application of ifm3d for ROS 2.
 */
class IFM3D_ROS2_PUBLIC PdsNode : public rclcpp_lifecycle::LifecycleNode
{
public:
  /**
   ...
   */
  explicit PdsNode(const std::string& node_name, const rclcpp::NodeOptions& opts);

  /**
   * Delegates construction to the above ctor.
   */
  explicit PdsNode(const rclcpp::NodeOptions& opts);
...
private:
  ...
  std::shared_ptr<PdsModule> pds_module_;
